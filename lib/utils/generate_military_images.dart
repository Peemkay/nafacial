...
class MilitaryImageGenerator {
  ...
  static Future<void> generateImages() async {
    ...
    // Generate each image
    await _generateImage('military_facial_scan.png', Colors.green,
        Icons.face_retouching_natural, imagesDir.path);

    await _generateImage('military_neural_network.png', Colors.blue,
        Icons.psychology, imagesDir.path);

    await _generateImage('military_biometric.png', Colors.purple,
        Icons.fingerprint, imagesDir.path);

    await _generateImage(
        'military_encryption.png', Colors.red, Icons.security, imagesDir.path);

    await _generateImage('military_surveillance.png', Colors.orange,
        Icons.shield, imagesDir.path);

    print('Generated military technology images at ${imagesDir.path}');
  }

  /// Generate a single image with military-themed design
  static Future<void> _generateImage(String filename, Color baseColor,
      IconData icon, String outputPath) async {
